describe TwoFactor::App do
  ...
  describe '#active!' do
    subject(:app) { member.app_two_factor }

    it 'activates an app' do
      app.active!
      expect(app.activated).to be true
    end
  end

  describe '#deactive!' do
    subject(:app) { create :two_factor_app, activated: true }

    it 'deactivates an app' do
      app.deactive!
      expect(app.activated).to be false
    end
  end
