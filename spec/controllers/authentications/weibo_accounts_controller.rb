    ...
    describe 'DELETE destroy' do
      ...
      context 'Only one authentication ' do
        ...
        it 'should tell user the reason' do
          do_request
          expect(flash[:alert]).to eq I18n.t('authentications.weibo.destroy.last_auth_alert')
        end
      end
      ...
      context 'More than one authentications' do
        ...
        it 'should set the flash message' do
          do_request
          expect(flash[:notice]).to eq I18n.t('authentications.weibo.destroy.unbind_success')
        end
      end
